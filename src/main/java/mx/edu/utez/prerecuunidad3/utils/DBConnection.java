package mx.edu.utez.prerecuunidad3.utils;

/*
* @Configuration: le dice a spring que esta clase de Java va a
* generar una configuración durante la ejecución de la aplicación,
* pero esta anotación debe siempre de ir con un método con la anotación
* bean que le diga que va a configurar
*
* @Bean: le indica a spring el método que retornará dicha
* configuración
* */
